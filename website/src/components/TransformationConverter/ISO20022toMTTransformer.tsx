...
const ISO20022toMTTransformer: React.FC = () => {
  ...
  const handleTransform = async () => {
    if (!inputMessage.trim()) {
      setError('Please enter an ISO 20022 message to transform');
      return;
    }
    ...
    const apiEndpoint = `${API_BASE_URL}/transform/mx-to-mt`;
    ...
    <>
      ...
      <div style={cardContainerStyle}>
        ...
        <textarea
          ...
          placeholder="Paste your ISO 20022 XML message here (e.g., pacs.008, pacs.002, camt.053)..."
        ...
        <button
          ...
          {...hoverEffects.primaryButton}
        >
          {loading ? <><span>⏳</span> Transforming...</> : <><span>🔄</span> Transform to SWIFT MT</>}
        </button>
      </div>
...
export default ISO20022toMTTransformer;